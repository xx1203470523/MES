...
namespace Hymson.MES.Services.Dtos.Manufacture
{
    ...
    /// 领料记录详情Dto
    /// </summary>
    public record ReportRequistionOrderResultDto : BaseEntityDto
    {
        /// <summary>
        /// 领料日期
        /// </summary>
    ...
    /// 领料记录详情分页Dto
    /// </summary>
    public class ReportRequistionOrderQueryDto : PagerInfo 
    {
        /// <summary>
        /// 仓库
        /// </summary>
    ...
    public class ReportRequistionOrderExportResultDto
    {
    ...
    /// 仓库名称分组
    /// </summary>
    public class ManuRequistionOrderGroupDto { 
        /// <summary>
        /// 仓库名称
        /// </summary>
        public string Warehouse { get; set;}

        public string Value => Warehouse;
    ...
    /// 仓库名称分组
    /// </summary>
    public class ManuRequistionOrderCodeGroupDto
    {
        /// <summary>
        /// 仓库名称
        /// </summary>
        ...
        public string Value => WarehouseCode;
    ...
    /// 导出领料
    /// </summary>
    public record ManuRequistionOrderDto : BaseEntityDto
    {
        /// <summary>
        /// 领料日期
        /// </summary>
    ...
    /// 导出退料
    /// </summary>
    public record ManuReturnsOrderDto : BaseEntityDto
    {
        /// <summary>
        /// 领料日期
        /// </summary>
