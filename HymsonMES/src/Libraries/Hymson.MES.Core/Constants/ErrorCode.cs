namespace Hymson.MES.Core.Constants
{
    ...
    public static partial class ErrorCode
    {
        ...
        public const string MES11993 = "检验单已生成，不允许重复生成！收货单【{Code}】";
        public const string MES11994 = "没有查询到检验单【{Code}】的明细！";
        public const string MES11995 = "检验单明细存在缺失！";
        public const string MES11996 = "检验单已生成，不允许重复生成！退料单【{Code}】";
        ...
        public const string MES15161 = "领料单【{ReqOrderCode}】收料状态已完成，不能领料！";
        public const string MES15162 = "领料单【{ReqOrderCode}】收料原始数据没有物料明细！";
        ...
        public const string MES15167 = "领料单【{ReqOrderCode}】异常：{Msg}";
        #endregion
        ...
        public const string MES16418 = "工单下发至LMS失败！错误信息:{msg}";
        #endregion
