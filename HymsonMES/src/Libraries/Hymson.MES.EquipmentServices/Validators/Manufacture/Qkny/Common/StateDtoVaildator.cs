...
namespace Hymson.MES.EquipmentServices.Validators.Manufacture.Qkny.Common
{
    ...
    /// 验证器
    /// </summary>
    internal class StateDtoVaildator : AbstractValidator<StateDto>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public StateDtoVaildator()
        {
            //设备编码不能为空
            ...
            //状态不能为空
            RuleFor(x => x.StateCode).NotEmpty().Must(list => list.Any()).WithErrorCode(ErrorCode.MES45170);
        }
    }
}
