...
namespace Hymson.MES.Data.Repositories.Warehouse
{
    ...
    public partial class WhMaterialStandingbookRepository
    {
        ...
        const string InsertSql = "INSERT INTO `wh_material_standingbook`(  `Id`, `MaterialCode`, `MaterialName`, `MaterialVersion`, `MaterialBarCode`, `Batch`, `Quantity`, `Unit`, `Type`, `Source`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (   @Id, @MaterialCode, @MaterialName, @MaterialVersion, @MaterialBarCode, @Batch, @Quantity, @Unit, @Type, @Source, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId )  ";
        const string InsertsSql = "INSERT INTO `wh_material_standingbook`(  `Id`, `MaterialCode`, `MaterialName`, `MaterialVersion`, `MaterialBarCode`, `Batch`, `Quantity`, `Unit`, `Type`, `Source`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (   @Id, @MaterialCode, @MaterialName, @MaterialVersion, @MaterialBarCode, @Batch, @Quantity, @Unit, @Type, @Source, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId )  ";
        ...
        const string GetByIdSql = @"SELECT 
                               `Id`, `MaterialCode`, `MaterialName`, `MaterialVersion`, `MaterialBarCode`, `Batch`, `Quantity`, `Unit`, `Type`, `Source`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`
