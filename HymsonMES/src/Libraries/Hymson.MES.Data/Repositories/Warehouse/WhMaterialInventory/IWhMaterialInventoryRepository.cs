...
namespace Hymson.MES.Data.Repositories.Warehouse
{
    ...
    public interface IWhMaterialInventoryRepository
    {
        ...
        /// <returns></returns>
        Task<int> UpdateQtyAsync(IEnumerable<WhMaterialInventoryEntity> entities);
        ...
        Task<IEnumerable<WhMaterialInventoryEntity>> GetByWorkOrderIdAsync(WhMaterialInventoryWorkOrderIdQuery param);
