...
/// <para>@层级：仓储层</para>
/// <para>@类型：查询对象</para>
/// <para>@描述：不合格代码关联不合格组表;标准查询对象</para>
/// <para>@作者：Jim</para>
/// <para>@创建时间：2024-3-12</para>
/// </summary>
public class QualUnqualifiedCodeGroupRelationQuery : QueryAbstraction
{
...
/// <para>@层级：仓储层</para>
/// <para>@类型：分页查询对象</para>
/// <para>@描述：不合格代码关联不合格组表;标准分页查询对象</para>
/// <para>@作者：Jim</para>
/// <para>@创建时间：2024-3-12</para>
/// </summary>
public class QualUnqualifiedCodeGroupRelationPagedQuery : PagerInfo
{
    /// <summary>
    /// 排序
    /// </summary>
