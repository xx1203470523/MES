...
/// </summary>
public partial class QualIqcInspectionItemDetailRepository : IQualIqcInspectionItemDetailRepository
{
    private readonly ConnectionOptions _connectionOptions;

    public QualIqcInspectionItemDetailRepository(IOptions<ConnectionOptions> connectionOptions)
    {
