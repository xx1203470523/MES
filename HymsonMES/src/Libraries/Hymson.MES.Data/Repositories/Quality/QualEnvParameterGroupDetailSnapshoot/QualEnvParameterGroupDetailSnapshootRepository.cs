...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualEnvParameterGroupDetailSnapshootRepository
    {
        ...
        const string InsertSql = "INSERT INTO qual_env_parameter_group_detail_snapshoot(  `Id`, `SiteId`, `ParameterGroupId`, `ParameterId`, `ParameterCode`, `ParameterName`, `ParameterUnit`, `ParameterDataType`, `UpperLimit`, `CenterValue`, `LowerLimit`, `ReferenceValue`, `EntryCount`, `Frequency`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @ParameterGroupId, @ParameterId, @ParameterCode, @ParameterName, @ParameterUnit, @ParameterDataType, @UpperLimit, @CenterValue, @LowerLimit, @ReferenceValue, @EntryCount, @Frequency, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        const string InsertsSql = "INSERT INTO qual_env_parameter_group_detail_snapshoot(  `Id`, `SiteId`, `ParameterGroupId`, `ParameterId`, `ParameterCode`, `ParameterName`, `ParameterUnit`, `ParameterDataType`, `UpperLimit`, `CenterValue`, `LowerLimit`, `ReferenceValue`, `EntryCount`, `Frequency`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @ParameterGroupId, @ParameterId, @ParameterCode, @ParameterName, @ParameterUnit, @ParameterDataType, @UpperLimit, @CenterValue, @LowerLimit, @ReferenceValue, @EntryCount, @Frequency, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";

        const string UpdateSql = "UPDATE qual_env_parameter_group_detail_snapshoot SET   SiteId = @SiteId, ParameterGroupId = @ParameterGroupId, ParameterId = @ParameterId, ParameterCode = @ParameterCode, ParameterName = @ParameterName, ParameterUnit = @ParameterUnit, ParameterDataType = @ParameterDataType, UpperLimit = @UpperLimit, CenterValue = @CenterValue, LowerLimit = @LowerLimit, ReferenceValue = @ReferenceValue, EntryCount = @EntryCount, Frequency = @Frequency, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE qual_env_parameter_group_detail_snapshoot SET   SiteId = @SiteId, ParameterGroupId = @ParameterGroupId, ParameterId = @ParameterId, ParameterCode = @ParameterCode, ParameterName = @ParameterName, ParameterUnit = @ParameterUnit, ParameterDataType = @ParameterDataType, UpperLimit = @UpperLimit, CenterValue = @CenterValue, LowerLimit = @LowerLimit, ReferenceValue = @ReferenceValue, EntryCount = @EntryCount, Frequency = @Frequency, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
