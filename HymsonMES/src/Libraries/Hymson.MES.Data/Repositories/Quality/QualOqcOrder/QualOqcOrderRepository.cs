...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualOqcOrderRepository
    {
        ...
        const string InsertSql = "INSERT INTO qual_oqc_order(  `Id`, `SiteId`, `InspectionOrder`, `GroupSnapshootId`, `MaterialId`, `CustomerId`, `ShipmentOrderId`, `ShipmentQty`, `Status`, `IsQualified`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @InspectionOrder, @GroupSnapshootId, @MaterialId, @CustomerId, @ShipmentOrderId, @ShipmentQty, @Status, @IsQualified, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        const string InsertsSql = "INSERT INTO qual_oqc_order(  `Id`, `SiteId`, `InspectionOrder`, `GroupSnapshootId`, `MaterialId`, `CustomerId`, `ShipmentOrderId`, `ShipmentQty`, `Status`, `IsQualified`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @InspectionOrder, @GroupSnapshootId, @MaterialId, @CustomerId, @ShipmentOrderId, @ShipmentQty, @Status, @IsQualified, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";

        const string UpdateSql = "UPDATE qual_oqc_order SET   SiteId = @SiteId, InspectionOrder = @InspectionOrder, GroupSnapshootId = @GroupSnapshootId, MaterialId = @MaterialId, CustomerId = @CustomerId, ShipmentOrderId = @ShipmentOrderId, ShipmentQty = @ShipmentQty, Status = @Status, IsQualified = @IsQualified, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE qual_oqc_order SET   SiteId = @SiteId, InspectionOrder = @InspectionOrder, GroupSnapshootId = @GroupSnapshootId, MaterialId = @MaterialId, CustomerId = @CustomerId, ShipmentOrderId = @ShipmentOrderId, ShipmentQty = @ShipmentQty, Status = @Status, IsQualified = @IsQualified, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
