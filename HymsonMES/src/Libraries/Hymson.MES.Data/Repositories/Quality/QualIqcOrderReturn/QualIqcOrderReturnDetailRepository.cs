...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualIqcOrderReturnDetailRepository
    {
        ...
        const string InsertSql = "INSERT INTO qual_iqc_order_return_detail(`Id`, `SiteId`, `IQCOrderId`, BarCode, `MaterialId`, `ReturnOrderDetailId`, `IsQualified`, `HandMethod`, `ProcessedBy`, `ProcessedOn`, `Remark`, `CreatedOn`, `CreatedBy`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @IQCOrderId, @BarCode, @MaterialId, @ReturnOrderDetailId, @IsQualified, @HandMethod, @ProcessedBy, @ProcessedOn, @Remark, @CreatedOn, @CreatedBy, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        const string InsertsSql = "INSERT INTO qual_iqc_order_return_detail(`Id`, `SiteId`, `IQCOrderId`, BarCode, `MaterialId`, `ReturnOrderDetailId`, `IsQualified`, `HandMethod`, `ProcessedBy`, `ProcessedOn`, `Remark`, `CreatedOn`, `CreatedBy`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @IQCOrderId, @BarCode, @MaterialId, @ReturnOrderDetailId, @IsQualified, @HandMethod, @ProcessedBy, @ProcessedOn, @Remark, @CreatedOn, @CreatedBy, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
