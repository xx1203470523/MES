...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualFqcParameterGroupSnapshootRepository
    {
        ...
        const string InsertSql = "INSERT INTO qual_fqc_parameter_group_snapshoot(  `Id`, `SiteId`, `Code`, `Name`, `MaterialId`, `SampleQty`, `LotSize`, `LotUnit`, `IsSameWorkOrder`, `IsSameWorkCenter`, `Version`, `Status`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @Code, @Name, @MaterialId, @SampleQty, @LotSize, @LotUnit, @IsSameWorkOrder, @IsSameWorkCenter, @Version, @Status, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        const string InsertsSql = "INSERT INTO qual_fqc_parameter_group_snapshoot(  `Id`, `SiteId`, `Code`, `Name`, `MaterialId`, `SampleQty`, `LotSize`, `LotUnit`, `IsSameWorkOrder`, `IsSameWorkCenter`, `Version`, `Status`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @Code, @Name, @MaterialId, @SampleQty, @LotSize, @LotUnit, @IsSameWorkOrder, @IsSameWorkCenter, @Version, @Status, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        ...
        const string GetByIdSql = @"SELECT * FROM qual_fqc_parameter_group_snapshoot WHERE IsDeleted=0 AND Id = @Id ";
        const string GetByIdsSql = @"SELECT * FROM qual_fqc_parameter_group_snapshoot WHERE IsDeleted=0 AND Id IN @Ids ";
