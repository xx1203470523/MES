...
public partial class QualUnqualifiedGroupRepository : BaseRepository, IQualUnqualifiedGroupRepository
{
    ...
    /// <param name="param"></param>
    /// <returns></returns>
    public async Task<int> InsertQualUnqualifiedCodeGroupRelationRangAsync(List<QualUnqualifiedCodeGroupRelationCreateCommand> param)
    {
        using var conn = new MySqlConnection(_connectionOptions.MESConnectionString);
    ...
    /// <param name="param"></param>
    /// <returns></returns>
    public async Task<int> InsertQualUnqualifiedGroupProcedureRelationRangAsync(List<QualUnqualifiedGroupProcedureRelationEntity> param)
    {
        using var conn = new MySqlConnection(_connectionOptions.MESConnectionString);
