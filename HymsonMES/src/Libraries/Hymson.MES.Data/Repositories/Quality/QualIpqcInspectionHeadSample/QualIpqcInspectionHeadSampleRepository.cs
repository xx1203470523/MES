...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualIpqcInspectionHeadSampleRepository : BaseRepository, IQualIpqcInspectionHeadSampleRepository
    {
        ...
        /// <returns></returns>
        public async Task<PagedInfo<QualIpqcInspectionHeadSampleEntity>> GetPagedListAsync(QualIpqcInspectionHeadSamplePagedQuery pagedQuery)
        {
            var sqlBuilder = new SqlBuilder();
            ...
            using var conn = GetMESDbConnection();
            var entitiesTask = conn.QueryAsync<QualIpqcInspectionHeadSampleEntity>(templateData.RawSql, templateData.Parameters);
    ...
    {
        const string GetPagedInfoDataSqlTemplate = @"SELECT /**select**/ FROM qual_ipqc_inspection_head_sample /**innerjoin**/ /**leftjoin**/ /**where**/ /**orderby**/ LIMIT @Offset,@Rows ";
        const string GetPagedInfoCountSqlTemplate = "SELECT COUNT(*) FROM qual_ipqc_inspection_head_sample /**innerjoin**/ /**leftjoin**/ /**where**/ /**orderby**/ ";
