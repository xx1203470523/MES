...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualIqcOrderLiteRepository : BaseRepository, IQualIqcOrderLiteRepository
    {
        ...
        public async Task<PagedInfo<QualIqcOrderLiteEntity>> GetPagedListAsync(QualIqcOrderLitePagedQuery pagedQuery)
        {
            ...
            //sqlBuilder.Select("*");
            sqlBuilder.Select(@" t1.*, t1.id,t1.InspectionOrder,t1.MaterialReceiptId, t2.ReceiptNum, t2.SyncCode, t1.SupplierId,t3.`Code` as supplierCode,t3.`Name` as supplierName,t1.`Status`,t1.CreatedBy,t1.CreatedOn,t4.MaterialCode,t4.MaterialName");
