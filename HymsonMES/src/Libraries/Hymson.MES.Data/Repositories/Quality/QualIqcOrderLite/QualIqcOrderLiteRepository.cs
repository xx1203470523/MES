...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualIqcOrderLiteRepository
    {
        ...
        const string UpdateSql = "UPDATE qual_iqc_order_lite SET   SiteId = @SiteId, InspectionOrder = @InspectionOrder, MaterialReceiptId = @MaterialReceiptId, SupplierId = @SupplierId, Status = @Status, IsQualified = @IsQualified, Remark = @Remark, CreatedOn = @CreatedOn, CreatedBy = @CreatedBy, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE qual_iqc_order_lite SET   SiteId = @SiteId, InspectionOrder = @InspectionOrder, MaterialReceiptId = @MaterialReceiptId, SupplierId = @SupplierId, Status = @Status, IsQualified = @IsQualified, Remark = @Remark, CreatedOn = @CreatedOn, CreatedBy = @CreatedBy, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
