...
namespace Hymson.MES.Data.Repositories.Quality
{
    ...
    public partial class QualIqcOrderLiteDetailRepository
    {
        ...
        const string UpdateSql = "UPDATE qual_iqc_order_lite_detail SET   SiteId = @SiteId, IQCOrderId = @IQCOrderId, MaterialId = @MaterialId, MaterialReceiptDetailId = @MaterialReceiptDetailId, Status = @Status, IsQualified = @IsQualified, HandMethod = @HandMethod, ProcessedBy = @ProcessedBy, ProcessedOn = @ProcessedOn, Remark = @Remark, CreatedOn = @CreatedOn, CreatedBy = @CreatedBy, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE qual_iqc_order_lite_detail SET   SiteId = @SiteId, IQCOrderId = @IQCOrderId, MaterialId = @MaterialId, MaterialReceiptDetailId = @MaterialReceiptDetailId, Status = @Status, IsQualified = @IsQualified, HandMethod = @HandMethod, ProcessedBy = @ProcessedBy, ProcessedOn = @ProcessedOn, Remark = @Remark, CreatedOn = @CreatedOn, CreatedBy = @CreatedBy, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
