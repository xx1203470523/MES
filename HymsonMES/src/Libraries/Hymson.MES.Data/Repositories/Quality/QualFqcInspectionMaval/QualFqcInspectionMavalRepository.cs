...
namespace Hymson.MES.Data.Repositories.QualFqcInspectionMaval
{
    ...
    public partial class QualFqcInspectionMavalRepository
    {
        ...
        const string InsertSql = "INSERT INTO `qual_fqc_inspection_maval`(  `Id`, `SiteId`, `ProcedureId`, `ResourceId`, `SFC`, `Qty`, `JudgmentResults`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @ProcedureId, @ResourceId, @SFC, @Qty, @JudgmentResults, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";
        const string InsertsSql = "INSERT INTO `qual_fqc_inspection_maval`(  `Id`, `SiteId`, `ProcedureId`, `ResourceId`, `SFC`, `Qty`, `JudgmentResults`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @ProcedureId, @ResourceId, @SFC, @Qty, @JudgmentResults, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";

        const string UpdateSql = "UPDATE `qual_fqc_inspection_maval` SET   SiteId = @SiteId, ProcedureId = @ProcedureId, ResourceId = @ResourceId, SFC = @SFC, Qty = @Qty, JudgmentResults = @JudgmentResults, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE `qual_fqc_inspection_maval` SET   SiteId = @SiteId, ProcedureId = @ProcedureId, ResourceId = @ResourceId, SFC = @SFC, Qty = @Qty, JudgmentResults = @JudgmentResults, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
