...
SELECT msc.SFC PACK, msc.CirculationBarCode MODULE, msc.SFC,1 LV FROM manu_sfc_circulation msc WHERE sfc IN (@SFC)
UNION ALL
...
SELECT T1.PACK, T1.SFC, ee.EquipmentName , mpp.JudgmentResult, mpp.LocalTime, pp.ParameterName , mpp.ParamValue, pp2.Code procedureCode, pp2.Name procedureName,
