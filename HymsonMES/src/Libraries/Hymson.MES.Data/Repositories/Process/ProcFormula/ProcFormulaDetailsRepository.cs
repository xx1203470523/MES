...
namespace Hymson.MES.Data.Repositories.Process
{
    ...
    public partial class ProcFormulaDetailsRepository
    {
        ...
        const string InsertSql = "INSERT INTO proc_formula_details(  `Id`, `Serial`, `FormulaId`, `FormulaOperationId`, `MaterialId`, `MaterialGroupId`, `ParameterId`, `FunctionCode`, `Setvalue`, `UpperLimit`, `LowLimit`, `Unit`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `SiteId`) VALUES (  @Id, @Serial, @FormulaId, @FormulaOperationId, @MaterialId, @MaterialGroupId, @ParameterId, @FunctionCode, @Setvalue, @UpperLimit, @LowLimit, @Unit, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @SiteId) ";
