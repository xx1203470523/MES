...
namespace Hymson.MES.Data.Repositories.Process
{
    ...
    public partial class ProcLabelTemplateRelationRepository
    {
        ...
        const string InsertSql = "INSERT INTO `proc_label_template_relation`(  `Id`, `LabelTemplateId`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`, `PrintConfig`, `PrintTemplatePath`) VALUES (   @Id, @LabelTemplateId, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId, @PrintConfig, @PrintTemplatePath )  ";
        const string InsertsSql = "INSERT INTO `proc_label_template_relation`(  `Id`, `LabelTemplateId`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`, `PrintConfig`, `PrintTemplatePath`) VALUES (   @Id, @LabelTemplateId, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId, @PrintConfig, @PrintTemplatePath )  ";

        const string UpdateSql = "UPDATE `proc_label_template_relation` SET   LabelTemplateId = @LabelTemplateId, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted, SiteId = @SiteId, PrintConfig = @PrintConfig, PrintTemplatePath = @PrintTemplatePath  WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE `proc_label_template_relation` SET   LabelTemplateId = @LabelTemplateId, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted, SiteId = @SiteId, PrintConfig = @PrintConfig, PrintTemplatePath = @PrintTemplatePath  WHERE Id = @Id ";
