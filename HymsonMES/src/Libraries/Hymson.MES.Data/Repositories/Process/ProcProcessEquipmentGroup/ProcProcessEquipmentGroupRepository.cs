...
namespace Hymson.MES.Data.Repositories.Process
{
    ...
    public partial class ProcProcessEquipmentGroupRepository
    {
        ...
        const string UpdateSql = "UPDATE `proc_process_equipment_group` SET   Code = @Code, Name = @Name, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted, SiteId = @SiteId  WHERE Id = @Id ";
