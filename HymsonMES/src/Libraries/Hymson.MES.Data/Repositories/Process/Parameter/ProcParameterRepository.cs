...
namespace Hymson.MES.Data.Repositories.Process
{
    ...
    public partial class ProcParameterRepository
    {
        ...
        const string UpdateSql = "UPDATE `proc_parameter` SET ParameterName = @ParameterName, ParameterUnit = @ParameterUnit, DataType = @DataType, Remark = @Remark, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn  WHERE Id = @Id ";
