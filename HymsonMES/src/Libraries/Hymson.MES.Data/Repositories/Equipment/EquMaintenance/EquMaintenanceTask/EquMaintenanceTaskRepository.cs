...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    public partial class EquMaintenanceTaskRepository
    {
        ...
        const string InsertSql = "INSERT INTO equ_maintenance_task(  `Id`, `EquipmentId`, `Code`, `Name`, `BeginTime`, `EndTime`, `Status`, `IsQualified`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @EquipmentId, @Code, @Name, @BeginTime, @EndTime, @Status, @IsQualified, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
        const string InsertsSql = "INSERT INTO equ_maintenance_task(  `Id`, `EquipmentId`, `Code`, `Name`, `BeginTime`, `EndTime`, `Status`, `IsQualified`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @EquipmentId, @Code, @Name, @BeginTime, @EndTime, @Status, @IsQualified, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
