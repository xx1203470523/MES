...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    public partial class EquMaintenanceTaskAttachmentRepository
    {
        ...
        const string InsertSql = "INSERT INTO equ_maintenance_task_attachment(  `Id`, `MaintenanceCheckTaskId`, `AttachmentId`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @MaintenanceCheckTaskId, @AttachmentId, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
        const string InsertsSql = "INSERT INTO equ_maintenance_task_attachment(  `Id`, `MaintenanceCheckTaskId`, `AttachmentId`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @MaintenanceCheckTaskId, @AttachmentId, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
