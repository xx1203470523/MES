...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    public partial class EquEquipmentTokenRepository
    {
        ...
        const string InsertSql = "INSERT INTO `equ_equipment_token`(  `Id`, `EquipmentId`,  `Token`, `ExpirationTime`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (   @Id, @EquipmentId,   @Token, @ExpirationTime, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId )  ON DUPLICATE KEY UPDATE UpdatedOn=NOW()";
        const string InsertsSql = "INSERT INTO `equ_equipment_token`(  `Id`, `EquipmentId`,   `Token`, `ExpirationTime`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (   @Id, @EquipmentId,  @Token, @ExpirationTime, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId )  ON DUPLICATE KEY UPDATE UpdatedOn=NOW()";
