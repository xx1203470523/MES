...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    public partial class EquSpotcheckTaskSnapshotItemRepository
    {
        ...
        const string InsertSql = "INSERT INTO equ_spotcheck_task_snapshot_item(  `Id`, `SpotCheckTaskId`, `SpotCheckItemId`, `Code`, `Name`, `Status`, `DataType`, `CheckType`, `CheckMethod`, `UnitId`, `OperationContent`, `Components`, `LowerLimit`, `Center`, `UpperLimit`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @SpotCheckTaskId, @SpotCheckItemId, @Code, @Name, @Status, @DataType, @CheckType, @CheckMethod, @UnitId, @OperationContent, @Components, @LowerLimit, @Center, @UpperLimit, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
        const string InsertsSql = "INSERT INTO equ_spotcheck_task_snapshot_item(  `Id`, `SpotCheckTaskId`, `SpotCheckItemId`, `Code`, `Name`, `Status`, `DataType`, `CheckType`, `CheckMethod`, `UnitId`, `OperationContent`, `Components`, `LowerLimit`, `Center`, `UpperLimit`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`) VALUES (  @Id, @SpotCheckTaskId, @SpotCheckItemId, @Code, @Name, @Status, @DataType, @CheckType, @CheckMethod, @UnitId, @OperationContent, @Components, @LowerLimit, @Center, @UpperLimit, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId) ";
