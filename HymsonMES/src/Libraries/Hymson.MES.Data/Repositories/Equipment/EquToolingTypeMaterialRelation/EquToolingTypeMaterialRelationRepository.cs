...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    /// 仓储（工具类型和物理关系表）
    /// </summary>
    public partial class EquToolingTypeMaterialRelationRepository : BaseRepository, IEquToolingTypeMaterialRelationRepository
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="connectionOptions"></param>
        public EquToolingTypeMaterialRelationRepository(IOptions<ConnectionOptions> connectionOptions) : base(connectionOptions) { }
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public async Task<IEnumerable<ToolingTypeMaterialRelationView>> GetSparePartsEquipmentGroupRelationAsync(long Id)
        {
            using var conn = GetMESDbConnection();
            return await conn.QueryAsync<ToolingTypeMaterialRelationView>(GetSparePartsEquipmentGroupRelationSqlTemplate, new { Id = Id });
        }
        ...
        /// <returns></returns>
        public async Task<int> InsertRangeAsync(IEnumerable<EquToolingTypeMaterialRelationEntity> entities)
        {
    ...
    /// 
    /// </summary>
    public partial class EquToolingTypeMaterialRelationRepository
    {
        ...
        const string InsertSql = "INSERT INTO `equ_tools_type_equipment_group_relation` (`ToolTypeId`, `MaterialId` ) VALUES ( @ToolTypeId, @MaterialId ) ";
