...
namespace Hymson.MES.Data.Repositories.Equipment.EquEquipmentLinkApi
{
    ...
    public partial class EquEquipmentLinkApiRepository : IEquEquipmentLinkApiRepository
    {
        ...
        {
            using var conn = new MySqlConnection(_connectionOptions.MESConnectionString);
            return await conn.ExecuteAsync(DeletesByEquipmentIdSql, new { equipmentIds });
        }
    ...
    public partial class EquEquipmentLinkApiRepository
    {
        ...
        const string DeletesByEquipmentIdSql = "DELETE FROM equ_equipment_link_api WHERE EquipmentId = @equipmentIds;";
        ...
        const string GetPagedInfoDataSqlTemplate = "SELECT /**select**/ FROM `equ_equipment_link_api` /**innerjoin**/ /**leftjoin**/ /**where**/ ORDER BY UpdatedOn DESC LIMIT @Offset,@Rows";
