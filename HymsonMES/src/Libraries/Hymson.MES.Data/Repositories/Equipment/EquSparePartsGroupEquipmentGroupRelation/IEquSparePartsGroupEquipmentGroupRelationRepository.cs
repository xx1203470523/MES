...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    /// 仓储接口（备件类型和设备关联关系表）
    /// </summary>
    public interface IEquSparePartsGroupEquipmentGroupRelationRepository
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<int> InsertAsync(EquSparePartsGroupEquipmentGroupRelationEntity entity);
        ...
        /// <returns></returns>
        Task<int> InsertRangeAsync(IEnumerable<EquSparePartsGroupEquipmentGroupRelationEntity> entities);
