...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    /// 仓储接口（工具绑定设备操作记录表）
    /// </summary>
    public interface IEquToolsEquipmentBindRecordRepository
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<int> InsertRangeAsync(IEnumerable<EquToolsEquipmentBindRecordEntity> entities);
        ...
        /// <param name="entities"></param>
        /// <returns></returns>
        Task<int> UpdateRangeAsync(IEnumerable<EquToolsEquipmentBindRecordEntity> entities);
        ...
        /// <returns></returns>
        Task<IEnumerable<EquToolsEquipmentBindRecordEntity>> GetByIdsAsync(long[] ids);
