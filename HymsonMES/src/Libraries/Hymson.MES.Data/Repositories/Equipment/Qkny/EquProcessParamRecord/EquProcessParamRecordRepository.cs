...
namespace Hymson.MES.Data.Repositories.EquProcessParamRecord
{
    ...
    public partial class EquProcessParamRecordRepository
    {
        ...
        const string InsertSql = "INSERT INTO equ_process_param_record(  `Id`, `EquipmentId`, `ParamId`, `ParamCode`, `ParamValue`, `CollectionTime`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `Remark`, `SiteId`) VALUES (  @Id, @EquipmentId, @ParamId, @ParamCode, @ParamValue, @CollectionTime, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @Remark, @SiteId) ";
        const string InsertsSql = "INSERT INTO equ_process_param_record(  `Id`, `EquipmentId`, `ParamId`, `ParamCode`, `ParamValue`, `CollectionTime`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `Remark`, `SiteId`) VALUES (  @Id, @EquipmentId, @ParamId, @ParamCode, @ParamValue, @CollectionTime, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @Remark, @SiteId) ";
