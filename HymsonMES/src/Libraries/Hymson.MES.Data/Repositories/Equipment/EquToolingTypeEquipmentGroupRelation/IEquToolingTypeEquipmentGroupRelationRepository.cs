...
namespace Hymson.MES.Data.Repositories.Equipment
{
    ...
    /// 仓储接口（工具类型和设备关联关系表）
    /// </summary>
    public interface IEquToolingTypeEquipmentGroupRelationRepository
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<int> InsertRangeAsync(IEnumerable<EquToolingTypeEquipmentGroupRelationEntity> entities);
