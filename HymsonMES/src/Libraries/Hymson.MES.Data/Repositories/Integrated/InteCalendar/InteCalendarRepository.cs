...
namespace Hymson.MES.Data.Repositories.Integrated.InteCalendar
{
    ...
    /// 日历维护仓储
    /// </summary>
    public partial class InteCalendarRepository : BaseRepository, IInteCalendarRepository
    {
        public InteCalendarRepository(IOptions<ConnectionOptions> connectionOptions) : base(connectionOptions)
        {
        }
    ...
    public partial class InteCalendarRepository
    {
        ...
        const string DeleteSql = "UPDATE `inte_calendar` SET IsDeleted = Id, UpdatedBy = @UserId, UpdatedOn = @DeleteOn WHERE IsDeleted = 0 AND Id IN @Ids;";
        ...
        const string GetPagedInfoCountSqlTemplate = "SELECT COUNT(*) FROM inte_calendar IC /**innerjoin**/ /**leftjoin**/ /**where**/";
