...
namespace Hymson.MES.Data.Repositories.Integrated
{
    ...
    public partial class InteVehicleFreightRepository
    {
        ...
        const string UpdateSql = "UPDATE `inte_vehicle_freight` SET   SiteId = @SiteId,Qty =@Qty, VehicleId = @VehicleId, Row=@Row, Column=@Column, Location = @Location, Status = @Status, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE `inte_vehicle_freight` SET   SiteId = @SiteId,Qty =@Qty, VehicleId = @VehicleId, Row=@Row, Column=@Column, Location = @Location, Status = @Status, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
