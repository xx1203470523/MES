...
namespace Hymson.MES.Data.Repositories.Integrated
{
    ...
    public partial class InteBusinessFieldRepository
    {
       // const string GetPagedInfoDataSqlTemplate = @"SELECT /**select**/ FROM inte_business_field /**innerjoin**/ /**leftjoin**/ /**where**/ /**orderby**/ LIMIT @Offset,@Rows ";
        ...
        const string UpdateSql = "UPDATE inte_business_field SET   SiteId = @SiteId, Code = @Code, Name = @Name, Type = @Type, Source = @Source, MaskCodeId = @MaskCodeId, Remark = @Remark, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE inte_business_field SET   SiteId = @SiteId, Code = @Code, Name = @Name, Type = @Type, Source = @Source, MaskCodeId = @MaskCodeId, Remark = @Remark, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted WHERE Id = @Id ";
