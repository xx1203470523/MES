...
namespace Hymson.MES.Data.Repositories.Integrated
{
    ...
    public partial class InteEventTypeMessageGroupRelationRepository
    {
        ...
        const string InsertsSql = "INSERT INTO inte_event_type_message_group_relation(  `Id`, `SiteId`, `EventTypeId`, `MessageGroupId`, `PushType`, `CreatedOn`, `CreatedBy`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @EventTypeId, @MessageGroupId, @PushType, @CreatedOn, @CreatedBy, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
