...
namespace Hymson.MES.Data.Repositories.Integrated
{
    ...
    public partial class InteCodeRulesRepository
    {
        ...
        const string InsertSql = "INSERT INTO `inte_code_rules`(  `Id`, `ProductId`, `CodeType`, CodeMode, `PackType`, `Base`, `IgnoreChar`, `Increment`, `OrderLength`, `ResetType`, StartNumber, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `SiteId`, `IsDeleted`) VALUES (   @Id, @ProductId, @CodeType, @PackType, @Base, @IgnoreChar, @Increment, @OrderLength, @ResetType, @StartNumber, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @SiteId, @IsDeleted )  ";
        const string InsertsSql = "INSERT INTO `inte_code_rules`(  `Id`, `ProductId`, `CodeType`, CodeMode, `PackType`, `Base`, `IgnoreChar`, `Increment`, `OrderLength`, `ResetType`, StartNumber, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `SiteId`, `IsDeleted`) VALUES (   @Id, @ProductId, @CodeType, @PackType, @Base, @IgnoreChar, @Increment, @OrderLength, @ResetType, @StartNumber, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @SiteId, @IsDeleted )  ";
