...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    /// 仓储接口（工单完工入库）
    /// </summary>
    public interface IManuProductReceiptOrderRepository
    {
        /// <summary>
        /// 新增
        /// </summary>
        ...
        /// <returns></returns>
        Task<int> InsertRangeAsync(IEnumerable<ManuProductReceiptOrderEntity> entities);
        ...
        /// <param name="entities"></param>
        /// <returns></returns>
        Task<int> UpdateRangeAsync(IEnumerable<ManuProductReceiptOrderEntity> entities);
        ...
        /// <returns></returns>
        Task<IEnumerable<ManuProductReceiptOrderEntity>> GetByIdsAsync(long[] ids);
