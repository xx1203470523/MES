...
cte.ordercode ,
    ...
    MAX(CASE WHEN fp.ParameterId = 22324930363162626 THEN fp.ParamValue else 0 END) AS column2,
    MAX(CASE WHEN fp.ParameterId = 22324930363162628 THEN fp.ParamValue else 0 END) AS column3,
    MAX(CASE WHEN fp.ParameterId = 22324930363162630 THEN fp.ParamValue else 0 END) AS column4,
    MAX(CASE WHEN fp.ParameterId = 22324930363162632 THEN fp.ParamValue else 0 END) AS column5,
    MAX(CASE WHEN fp.ParameterId = 22324930363162634 THEN fp.ParamValue else 0 END) AS column6,
    MAX(CASE WHEN fp.ParameterId = 22324930363162636 THEN fp.ParamValue else 0 END) AS column7,
    MAX(CASE WHEN fp.ParameterId = 22324930363162638 THEN fp.ParamValue else 0 END) AS column8,
    MAX(CASE WHEN fp.ParameterId = 22324930363162640 THEN fp.ParamValue else 0 END) AS column9,
    MAX(CASE WHEN fp.ParameterId = 22324930363162642 THEN fp.ParamValue else 0 END) AS column10,
    MAX(CASE WHEN fp.ParameterId = 22324930363162644 THEN fp.ParamValue else 0 END) AS column11,
    MAX(CASE WHEN fp.ParameterId = 22324930363162646 THEN fp.ParamValue else 0 END) AS column12,
    MAX(CASE WHEN fp.ParameterId = 22324930363162648 THEN fp.ParamValue else 0 END) AS column13,
    MAX(CASE WHEN fp.ParameterId = 22324930363162650 THEN fp.ParamValue else 0 END) AS column14,
    MAX(CASE WHEN fp.ParameterId = 22324930363162652 THEN fp.ParamValue else 0 END) AS column15,
    MAX(CASE WHEN fp.ParameterId = 22324930363162654 THEN fp.ParamValue else 0 END) AS column16,
    cte.CreatedBy, 
    cte.CreatedOn
