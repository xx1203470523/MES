...
namespace Hymson.MES.Data.Repositories.Manufacture.ManuFeeding
{
    ...
    public partial class ManuFeedingRepository
    {
        ...
        const string UpdateQtyByProductIdSql = "UPDATE manu_feeding SET Qty = @Qty, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn WHERE ResourceId = @ResourceId AND ProductId = @ProductId AND Id = @Id; ";
