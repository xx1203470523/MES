...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuReturnOrderRepository
    {
        ...
        const string InsertSql = "INSERT INTO manu_return_order(  `Id`, `ReqOrderCode`, `TargetWorkOrderCode`, `Type`, `Status`, `Qty`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`, `SourceWorkOrderCode`) VALUES (  @Id, @ReqOrderCode, @TargetWorkOrderCode, @Type, @Status, @Qty, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId, @SourceWorkOrderCode) ";
        const string InsertsSql = "INSERT INTO manu_return_order(  `Id`, `ReqOrderCode`, `TargetWorkOrderCode`, `Type`, `Status`, `Qty`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`, `SourceWorkOrderCode`) VALUES (  @Id, @ReqOrderCode, @TargetWorkOrderCode, @Type, @Status, @Qty, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId, @SourceWorkOrderCode) ";

        const string UpdateSql = "UPDATE manu_return_order SET   ReqOrderCode = @ReqOrderCode, TargetWorkOrderCode = @TargetWorkOrderCode, Type = @Type, Status = @Status, Qty = @Qty, Remark = @Remark, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted, SiteId = @SiteId, SourceWorkOrderCode = @SourceWorkOrderCode WHERE Id = @Id ";
