...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuSfcScrapRepository
    {
        ...
        const string InsertSql = "INSERT INTO manu_sfc_scrap(  `Id`, `SiteId`, `SFC`, `SfcinfoId`,`SfcStepId`,  `ProcedureId`, `ScrapQty`, `IsCancel`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @SFC, @SfcinfoId,@SfcStepId, @ProcedureId, @ScrapQty, @IsCancel, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
        const string InsertsSql = "INSERT INTO manu_sfc_scrap(  `Id`, `SiteId`, `SFC`, `SfcinfoId`,`SfcStepId`, `ProcedureId`, `ScrapQty`, `IsCancel`, `Remark`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (  @Id, @SiteId, @SFC, @SfcinfoId,@SfcStepId, @ProcedureId, @ScrapQty, @IsCancel, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted) ";
