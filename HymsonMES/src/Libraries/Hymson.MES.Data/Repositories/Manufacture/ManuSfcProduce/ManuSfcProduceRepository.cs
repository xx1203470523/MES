...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuSfcProduceRepository
    {
        ...
        const string UpdateWithStatusCheckSql = "UPDATE manu_sfc_produce SET ResourceId = @ResourceId, ProcedureId = @ProcedureId, RepeatedCount = @RepeatedCount, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn WHERE Id = @Id AND Status <> @Status; ";
