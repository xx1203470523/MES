...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuSfcProduceRepository
    {
        ...
        const string DeleteSfcProduceBusinessBySfcInfoIdsSql = "DELETE FROM manu_sfc_produce_business WHERE SfcProduceId IN @SfcInfoIds AND SiteId = @SiteId ";
