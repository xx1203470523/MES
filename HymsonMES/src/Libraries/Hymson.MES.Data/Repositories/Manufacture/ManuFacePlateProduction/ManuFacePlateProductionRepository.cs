...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuFacePlateProductionRepository
    {
        ...
        const string InsertSql = "INSERT INTO `manu_face_plate_production`(  `Id`, `SiteId`, `FacePlateId`, `ResourceId`, `IsResourceEdit`, `ProcedureId`, `IsProcedureEdit`, `IsSuccessBeep`, `SuccessBeepUrl`, `SuccessBeepTime`, `IsErrorBeep`, `ErrorBeepUrl`, `ErrorBeepTime`, `IsShowBindWorkOrder`, `IsShowQualifiedQty`, `QualifiedColour`, `IsShowUnqualifiedQty`, `UnqualifiedColour`, `IsShowLog`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @FacePlateId, @ResourceId, @IsResourceEdit, @ProcedureId, @IsProcedureEdit, @IsSuccessBeep, @SuccessBeepUrl, @SuccessBeepTime, @IsErrorBeep, @ErrorBeepUrl, @ErrorBeepTime, @IsShowBindWorkOrder, @IsShowQualifiedQty, @QualifiedColour, @IsShowUnqualifiedQty, @UnqualifiedColour, @IsShowLog, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";
        const string InsertsSql = "INSERT INTO `manu_face_plate_production`(  `Id`, `SiteId`, `FacePlateId`, `ResourceId`, `IsResourceEdit`, `ProcedureId`, `IsProcedureEdit`, `IsSuccessBeep`, `SuccessBeepUrl`, `SuccessBeepTime`, `IsErrorBeep`, `ErrorBeepUrl`, `ErrorBeepTime`, `IsShowBindWorkOrder`, `IsShowQualifiedQty`, `QualifiedColour`, `IsShowUnqualifiedQty`, `UnqualifiedColour`, `IsShowLog`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @FacePlateId, @ResourceId, @IsResourceEdit, @ProcedureId, @IsProcedureEdit, @IsSuccessBeep, @SuccessBeepUrl, @SuccessBeepTime, @IsErrorBeep, @ErrorBeepUrl, @ErrorBeepTime, @IsShowBindWorkOrder, @IsShowQualifiedQty, @QualifiedColour, @IsShowUnqualifiedQty, @UnqualifiedColour, @IsShowLog, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";

        const string UpdateSql = "UPDATE `manu_face_plate_production` SET   SiteId = @SiteId, FacePlateId = @FacePlateId, ResourceId = @ResourceId, IsResourceEdit = @IsResourceEdit, ProcedureId = @ProcedureId, IsProcedureEdit = @IsProcedureEdit, IsSuccessBeep = @IsSuccessBeep, SuccessBeepUrl = @SuccessBeepUrl, SuccessBeepTime = @SuccessBeepTime, IsErrorBeep = @IsErrorBeep, ErrorBeepUrl = @ErrorBeepUrl, ErrorBeepTime = @ErrorBeepTime, IsShowBindWorkOrder = @IsShowBindWorkOrder, IsShowQualifiedQty = @IsShowQualifiedQty, QualifiedColour = @QualifiedColour, IsShowUnqualifiedQty = @IsShowUnqualifiedQty, UnqualifiedColour = @UnqualifiedColour, IsShowLog = @IsShowLog, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE `manu_face_plate_production` SET   SiteId = @SiteId, FacePlateId = @FacePlateId, ResourceId = @ResourceId, IsResourceEdit = @IsResourceEdit, ProcedureId = @ProcedureId, IsProcedureEdit = @IsProcedureEdit, IsSuccessBeep = @IsSuccessBeep, SuccessBeepUrl = @SuccessBeepUrl, SuccessBeepTime = @SuccessBeepTime, IsErrorBeep = @IsErrorBeep, ErrorBeepUrl = @ErrorBeepUrl, ErrorBeepTime = @ErrorBeepTime, IsShowBindWorkOrder = @IsShowBindWorkOrder, IsShowQualifiedQty = @IsShowQualifiedQty, QualifiedColour = @QualifiedColour, IsShowUnqualifiedQty = @IsShowUnqualifiedQty, UnqualifiedColour = @UnqualifiedColour, IsShowLog = @IsShowLog, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
