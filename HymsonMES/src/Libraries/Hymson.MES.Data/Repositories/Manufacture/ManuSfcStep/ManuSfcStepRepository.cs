...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuSfcStepRepository
    {
        ...
        const string GetByIdSql = @"SELECT 
                               `Id`, `SFC`, `ProductId`, `WorkOrdeId`, `WorkCenterId`, `ProductBOMId`, `Qty`, `EquipmentId`, `ResourceId`, `ProcedureId`, `Type`, `Status`, `Lock`, `IsMultiplex`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`
