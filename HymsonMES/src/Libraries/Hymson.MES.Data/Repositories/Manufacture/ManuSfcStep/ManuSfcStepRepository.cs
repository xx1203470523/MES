...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuSfcStepRepository
    {
        ...
        const string GetByIdSql = @"SELECT 
                               `Id`, `SFC`, `ProductId`, `WorkOrderId`, `WorkCenterId`, `ProductBOMId`, `Qty`, `EquipmentId`, `ResourceId`, `ProcedureId`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, `SiteId`, `Passed`, `IsPassingStation`
