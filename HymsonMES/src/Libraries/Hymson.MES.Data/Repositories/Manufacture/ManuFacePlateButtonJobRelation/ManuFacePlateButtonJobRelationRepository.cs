...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuFacePlateButtonJobRelationRepository
    {
        ...
        const string InsertSql = "INSERT INTO `manu_face_plate_button_job_relation`(  `Id`, `SiteId`, `FacePlateButtonId`, `JobId`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @FacePlateButtonId, @JobId, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";
        const string InsertsSql = "INSERT INTO `manu_face_plate_button_job_relation`(  `Id`, `SiteId`, `FacePlateButtonId`, `JobId`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`) VALUES (   @Id, @SiteId, @FacePlateButtonId, @JobId, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted )  ";

        const string UpdateSql = "UPDATE `manu_face_plate_button_job_relation` SET   SiteId = @SiteId, FacePlateButtonId = @FacePlateButtonId, JobId = @JobId, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
        const string UpdatesSql = "UPDATE `manu_face_plate_button_job_relation` SET   SiteId = @SiteId, FacePlateButtonId = @FacePlateButtonId, JobId = @JobId, CreatedBy = @CreatedBy, CreatedOn = @CreatedOn, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn, IsDeleted = @IsDeleted  WHERE Id = @Id ";
