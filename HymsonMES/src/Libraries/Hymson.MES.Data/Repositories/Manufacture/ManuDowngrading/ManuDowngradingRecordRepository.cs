...
namespace Hymson.MES.Data.Repositories.Manufacture
{
    ...
    public partial class ManuDowngradingRecordRepository
    {
        ...
        const string InsertSql = "INSERT INTO `manu_downgrading_record`(  `Id`, `SiteId`, `SFC`, `Grade`, `IsCancellation`, `CreatedOn`, `CreatedBy`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, Remark,ProcedureId, SfcInfoId) VALUES (   @Id, @SiteId, @SFC, @Grade, @IsCancellation, @CreatedOn, @CreatedBy, @UpdatedBy, @UpdatedOn, @IsDeleted , @Remark,@ProcedureId, @SfcInfoId)  ";
        const string InsertsSql = "INSERT INTO `manu_downgrading_record`(  `Id`, `SiteId`, `SFC`, `Grade`, `IsCancellation`, `CreatedOn`, `CreatedBy`, `UpdatedBy`, `UpdatedOn`, `IsDeleted`, Remark,ProcedureId, SfcInfoId) VALUES (   @Id, @SiteId, @SFC, @Grade, @IsCancellation, @CreatedOn, @CreatedBy, @UpdatedBy, @UpdatedOn, @IsDeleted, @Remark,@ProcedureId, @SfcInfoId)  ";
