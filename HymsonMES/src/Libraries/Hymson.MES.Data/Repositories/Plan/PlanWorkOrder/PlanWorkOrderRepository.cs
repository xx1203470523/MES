...
namespace Hymson.MES.Data.Repositories.Plan
{
    ...
    public partial class PlanWorkOrderRepository : IPlanWorkOrderRepository
    {
        ...
        public async Task<PagedInfo<PlanWorkOrderListDetailView>> GetPagedInfoAsync(PlanWorkOrderPagedQuery pageQuery)
        {
            ...
            sqlBuilder.Where("wo.IsDeleted = 0 AND wor.IsDeleted = 0");
    ...
    FROM `plan_work_order` /**where**/  ";
        ...
        const string UpdatePassDownQuantitySql = "UPDATE plan_work_order_record SET PassDownQuantity=PassDownQuantity-@PassDownQuantity,UpdatedBy=@UserName,UpdatedOn=@UpdateDate WHERE WorkOrderId=@WorkOrderId AND PassDownQuantity<=@PlanQuantity AND IsDeleted=0";
