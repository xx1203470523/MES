...
namespace Hymson.MES.Data.Repositories.Plan
{
    ...
    public partial class PlanWorkPlanRepository
    {
        ...
        const string InsertsSql = "INSERT INTO plan_work_plan(Id, WorkPlanCode, Type, Status, IsOpen, RequirementNumber, PlanStartTime, PlanEndTime, Remark, CreatedBy, CreatedOn, UpdatedBy, UpdatedOn, IsDeleted, SiteId, PlanType) VALUES (@Id, @WorkPlanCode, @Type, @Status, @IsOpen, @RequirementNumber, @PlanStartTime, @PlanEndTime, @Remark, @CreatedBy, @CreatedOn, @UpdatedBy, @UpdatedOn, @IsDeleted, @SiteId, @PlanType) ";

        const string UpdateSql = "UPDATE plan_work_plan SET RequirementNumber = @RequirementNumber, Type = @Type, PlanType = @PlanType, Status = @Status, IsOpen = @IsOpen, PlanStartTime = @PlanStartTime, PlanEndTime = @PlanEndTime, Remark = @Remark, UpdatedBy = @UpdatedBy, UpdatedOn = @UpdatedOn WHERE Id = @Id ";
