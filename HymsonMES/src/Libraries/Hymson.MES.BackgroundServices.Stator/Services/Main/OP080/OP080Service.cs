...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP080Service : IOP080Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP080Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP080> _opRepository;
        ...
        public OP080Service(ILogger<OP080Service> logger,
            IOPRepository<OP080> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP080).Name}";

            // 读取未赋值的条码（槽底纸）
            var ids = await _mainService.GetInnerIdsByNullColumnAsync("PaperBottomLotBarcode");
            if (ids == null || !ids.Any())
            {
        ...
        /// <returns></returns>
        private async Task<StatorSummaryBo> ConvertDataListAsync(IEnumerable<OP080> entities, IEnumerable<string> barCodes, IEnumerable<string>? parameterCodes = null)
        {
            var producreCode = $"{typeof(OP080).Name}";
            ...
            foreach (var opEntity in entities)
            {
                ...
                */
                ...
                summaryBo.ManuSfcCirculationEntities.Add(new ManuSfcCirculationEntity
                {
                    ...
                    CirculationProductId = materialId,// 51558094604398592
                    CirculationMainProductId = materialId,// 51558094067523584
                    ...
                    CreatedBy = statorBo.User,
                    CreatedOn = statorBo.Time,
                    UpdatedBy = "OP080",//StatorConst.USER,
                    UpdatedOn = time
                });
