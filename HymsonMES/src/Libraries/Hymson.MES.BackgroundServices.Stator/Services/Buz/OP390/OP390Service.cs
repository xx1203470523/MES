...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP390Service : IOP390Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP390Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP390> _opRepository;
        ...
        public OP390Service(ILogger<OP390Service> logger,
            IOPRepository<OP390> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP390).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP390Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
        private static readonly List<string> _parameterCodes = new()
        {
            "Resistance1Result",
            "Resistance1",
            "ResistanceUnbalanceResult",
            "ResistanceUnbalance",
            "InsulationResistanceResult",
            "InsulationResistance",
            "ACwithstandVoltage1Result",
            "TurnToTurn1Result",
            "Area1",
            "DifferenceProduct1"
        };
