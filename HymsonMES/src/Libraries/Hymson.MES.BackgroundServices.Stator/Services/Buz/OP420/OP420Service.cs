...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP420Service : IOP420Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP420Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP420> _opRepository;
        ...
        public OP420Service(ILogger<OP420Service> logger,
            IOPRepository<OP420> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP420).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP420Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
