...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP290Service : IOP290Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP290Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP290> _opRepository;
        ...
        public OP290Service(ILogger<OP290Service> logger,
            IOPRepository<OP290> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP290).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP290Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
        ...
        {
            "TransferCutPosition1",
            "TransferCutSpeed1",
            "TransferCutPosition2",
            "TransferCutSpeed2",
            "CuttingCutPosition",
            "CuttingCutSpeed"
        };
