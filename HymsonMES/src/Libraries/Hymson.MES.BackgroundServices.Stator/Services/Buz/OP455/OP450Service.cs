...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP455Service : IOP455Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP455Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP455> _opRepository;
        ...
        public OP455Service(ILogger<OP455Service> logger,
            IOPRepository<OP455> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP455).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP455Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
