...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP310Service : IOP310Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP310Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP310> _opRepository;
        ...
        public OP310Service(ILogger<OP310Service> logger,
            IOPRepository<OP310> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP310).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP310Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
