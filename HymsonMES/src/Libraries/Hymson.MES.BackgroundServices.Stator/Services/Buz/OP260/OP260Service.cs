...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP260Service : IOP260Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP260Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP260> _opRepository;
        ...
        public OP260Service(ILogger<OP260Service> logger,
            IOPRepository<OP260> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP260).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP260Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
        ...
        {
            "ExpandingFormingUnitStandbyPosition",
            "ExpandingFormingUnitStandbySpeed",
            "ExpandingFormingUnitFormingPosition",
            "ExpandingFormingUnitFormingSpeed",
            "AutoLoaderUpPosition",
            "AutoLoaderUpSpeed",
            "AutoLoaderReceivePosition",
            "AutoLoaderReceiveSpeed",
            "AutoLoaderGivePosition",
            "AutoLoaderGiveSpeed"
        };
