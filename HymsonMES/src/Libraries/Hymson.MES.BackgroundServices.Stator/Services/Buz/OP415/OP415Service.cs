...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP415Service : IOP415Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP415Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP415> _opRepository;
        ...
        public OP415Service(ILogger<OP415Service> logger,
            IOPRepository<OP415> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP415).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP415Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
