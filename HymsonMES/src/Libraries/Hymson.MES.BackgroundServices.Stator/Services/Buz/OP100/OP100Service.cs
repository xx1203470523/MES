...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    public partial class OP100Service : IOP100Service
    {
        ...
        public async Task<int> ExecuteAsync(int limitCount)
        {
            ...
            _logger.LogInformation($"OP100 水位线；时间： {waterMarkId.ToString()}");
            ...
            // 获取转换数据（基础数据）
            var summaryBo = await _mainService.ConvertDataTableInnerAsync(dataTable, producreCode, _parameterCodes);
