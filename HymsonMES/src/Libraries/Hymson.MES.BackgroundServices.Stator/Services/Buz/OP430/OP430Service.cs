...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP430Service : IOP430Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP430Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP430> _opRepository;
        ...
        public OP430Service(ILogger<OP430Service> logger,
            IOPRepository<OP430> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP430).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP430Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
