...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP130Service : IOP130Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP130Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP130> _opRepository;
        ...
        public OP130Service(ILogger<OP130Service> logger,
            IOPRepository<OP130> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP130).Name}";
