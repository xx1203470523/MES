...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP450Service : IOP450Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP450Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP450> _opRepository;
        ...
        public OP450Service(ILogger<OP450Service> logger,
            IOPRepository<OP450> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP450).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP450Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
