...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP180Service : IOP180Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP180Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP180> _opRepository;
        ...
        public OP180Service(ILogger<OP180Service> logger,
            IOPRepository<OP180> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP180).Name}";
