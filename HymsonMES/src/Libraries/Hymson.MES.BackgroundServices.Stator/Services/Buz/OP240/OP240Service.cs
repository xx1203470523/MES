...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP240Service : IOP240Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP240Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP240> _opRepository;
        ...
        public OP240Service(ILogger<OP240Service> logger,
            IOPRepository<OP240> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP240).Name}";
