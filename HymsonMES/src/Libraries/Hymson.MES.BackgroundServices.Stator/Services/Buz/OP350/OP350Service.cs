...
namespace Hymson.MES.BackgroundServices.Stator.Services
{
    ...
    /// 服务
    /// </summary>
    public partial class OP350Service : IOP350Service
    {
        /// <summary>
        /// 日志接口
        /// </summary>
        private readonly ILogger<OP350Service> _logger;

        /// <summary>
        /// 仓储接口（工序）
        /// </summary>
        private readonly IOPRepository<OP350> _opRepository;
        ...
        public OP350Service(ILogger<OP350Service> logger,
            IOPRepository<OP350> opRepository,
        ...
        {
            var producreCode = $"{typeof(OP350).Name}";
    ...
    /// 服务
    /// </summary>
    public partial class OP350Service
    {
        /// <summary>
        /// 参数编码集合
        /// </summary>
