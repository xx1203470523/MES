...
namespace Hymson.MES.CoreServices.Services.Manufacture.ManuCreateBarcode
{
    ...
    public interface IManuCreateBarcodeService
    {
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        Task<string> CreateCellBarCodeAsync(CreateCellBarcodeBo bo);
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        Task<string> CreateCellBarCodeBySfcAsync(CreateCellBarcodeBySfcBo bo);
        ...
        /// <param name="bo"></param>
        /// <returns></returns>
        Task ReceiveCellBarCodeBySfcAsync(ReceiveCellBarcodeBo bo);
    }
}
