...
namespace Hymson.MES.CoreServices.Services.Manufacture.ManuMainstreamProcess.GenerateBarcode
{
    ...
    public class ManuGenerateBarcodeService : IManuGenerateBarcodeService
    {
        ...
        public async Task<IEnumerable<string>> GenerateBarcodeListByIdAsync(GenerateBarcodeDto param)
        {
            ...
            var getCodeRulesMakeListTask = _inteCodeRulesMakeRepository.GetInteCodeRulesMakeEntitiesAsync(new InteCodeRulesMakeQuery { SiteId = param.SiteId, CodeRulesId = param.CodeRuleId });
