...
namespace Hymson.MES.CoreServices.Services.Job
{
    ...
    /// 
    /// </summary>
    [Job("不合格标识拦截", JobTypeEnum.Standard)]
    public class UnqualifiedMarkInterceptJobService : IJobService
    {
        /// <summary>
        /// 仓储接口（产品不良录入）
        /// </summary>
        ...
        public UnqualifiedMarkInterceptJobService(IManuProductBadRecordRepository manuProductBadRecordRepository,
