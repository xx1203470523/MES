...
namespace Hymson.MES.Services.Dtos.EquMaintenanceTemplate
{
    ...
    /// 设备点检模板Dto
    /// </summary>
    public record EquMaintenanceTemplateDto : BaseEntityDto
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// 设备点检模板新增Dto
    /// </summary>
    public record EquMaintenanceTemplateCreateDto : BaseEntityDto
    {
        ...
        /// 模板与项目
        /// </summary>
        public IEnumerable<EquMaintenanceTemplateItemRelationDto> relationDto { get; set; }

        /// <summary>
        /// 模板与设备组
        /// </summary>
        public IEnumerable<EquMaintenanceTemplateEquipmentGroupRelationDto> groupRelationDto { get; set; }
    ...
    /// 设备点检模板更新Dto
    /// </summary>
    public record EquMaintenanceTemplateModifyDto : BaseEntityDto
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// 设备点检模板分页Dto
    /// </summary>
    public class EquMaintenanceTemplatePagedQueryDto : PagerInfo
    {
    ...
    /// 删除数据
    /// </summary>
    public record EquMaintenanceTemplateDeleteDto
    {
        /// <summary>
        /// 要删除的组
        /// </summary>
    ...
    /// 设备点检模板与项目关系Dto
    /// </summary>
    public record EquMaintenanceTemplateItemRelationDto
    {
    ...
    /// 设备点检模板与设备组关系Dto
    /// </summary>
    public record EquMaintenanceTemplateEquipmentGroupRelationDto
    {
    ...
    /// 设备点检模板与项目关系 查询参数
    /// </summary> 
    public record GetEquMaintenanceTemplateItemRelationDto
    {
        /// <summary>
        /// 模板IDs
        /// </summary>
