...
namespace Hymson.MES.Services.Dtos.Quality
{
    ...
    /// 巡检检验单新增Dto
    /// </summary>
    public record QualIpqcInspectionPatrolSaveDto : BaseEntityDto
    {
        /// <summary>
        /// 生成条件单位
        /// </summary>
    ...
    /// 巡检检验单Dto
    /// </summary>
    public record QualIpqcInspectionPatrolDto : BaseEntityDto
    {
        /// <summary>
        /// 主键
        /// </summary>
    ...
    /// 巡检检验单分页Dto
    /// </summary>
    public class QualIpqcInspectionPatrolPagedQueryDto : PagerInfo
    {
        /// <summary>
        /// 单号
        /// </summary>
