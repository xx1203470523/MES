...
namespace Hymson.MES.Services.Mapper
{
    ...
    public class MapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateNioMaps()
        {
            ...
            CreateMap<NioPushCollectionStatusView, NioPushCollectionDto>();
            CreateMap<NioPushCollectionDto, NioPushCollectionEntity>();
            CreateMap<NioPushCollectionSaveDto, NioPushCollectionEntity>();

            CreateMap<NioPushProductioncapacityPagedQueryDto, NioPushProductioncapacityPagedQuery>();
            CreateMap<NioPushProductioncapacityEntity, NioPushProductioncapacityDto>();
            ...
            CreateMap<NioPushActualDeliveryPagedQueryDto, NioPushActualDeliveryPagedQuery>();
            CreateMap<NioPushActualDeliveryEntity, NioPushActualDeliveryDto>();
            CreateMap<NioPushActualDeliveryView, NioPushActualDeliveryDto>();
            CreateMap<NioPushActualDeliveryDto, NioPushActualDeliveryEntity>();
            CreateMap<NioPushActualDeliverySaveDto, NioPushActualDeliveryEntity>();
        }
