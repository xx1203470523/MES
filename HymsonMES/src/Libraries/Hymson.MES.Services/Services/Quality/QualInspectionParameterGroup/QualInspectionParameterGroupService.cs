...
namespace Hymson.MES.Services.Services.Quality
{
    ...
    public class QualInspectionParameterGroupService : IQualInspectionParameterGroupService
    {
        ...
        /// <returns></returns>
        public async Task<IEnumerable<QualInspectionParameterGroupDetailDto>> QueryDetailsByParameterGroupIdAsync(long parameterGroupId)
        {
        ...
        public async Task<PagedInfo<QualInspectionParameterGroupDto>> GetPagedListAsync(QualInspectionParameterGroupPagedQueryDto pagedQueryDto)
        {
            ...
            var pagedInfo = await _qualInspectionParameterGroupRepository.GetPagedInfoAsync(pagedQuery);
