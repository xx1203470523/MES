...
namespace Hymson.MES.Services.Services.Process.Procedure
{
    ...
    public partial class ProcPrintSetupService : IProcPrintSetupService
    {
        ...
        {
            var procConversionFactorEntity = await _procPrintSetupRepository.GetByIdAsync(id);
        ...
        public async Task<long> AddProcConversionFactorAsync(AddPrintSetupDto AddConversionFactorDto)
        {
            //校验字段空值
            ...
            var procPrintSetupEntity = AddConversionFactorDto.ToEntity<ProcPrintSetupEntity>();
            procPrintSetupEntity.MaterialId = AddConversionFactorDto.MaterialId;
            procPrintSetupEntity.Type = AddConversionFactorDto.Type;
            procPrintSetupEntity.BusinessType= AddConversionFactorDto.BusinessType;
            procPrintSetupEntity.LabelTemplateId = AddConversionFactorDto.LabelTemplateId;
            procPrintSetupEntity.Count=AddConversionFactorDto.Count;
            ...
            procPrintSetupEntity.Status = AddConversionFactorDto.Status;
            ...
            var isExists = (await _procPrintSetupRepository.GetProcConversionFactorEntitiesAsync(new ProcPrintSetupQuery()
            {
                ...
                //BusinessType = procConversionFactorEntity.BusinessType,
